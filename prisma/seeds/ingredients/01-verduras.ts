...
export const verduras: IngredientSeedData[] = [
  ...
  // ── AÑADIDOS DESDE SQL ──────────────────────────────────────────────────
  {
    ...
    conversions: [
      { unitName: "espárrago triguero", gramsPerUnit: 12 },
      { unitName: "manojo", gramsPerUnit: 200 },
    ],
  },
  {
    name: "Chirivía",
    ...
    conversions: [{ unitName: "chirivía", gramsPerUnit: 100 }],
  },
  {
    name: "Tomate pera",
    unit: "g",
    ...
    conversions: [{ unitName: "tomate pera", gramsPerUnit: 120 }],
  },
  {
    name: "Cebolla morada",
    unit: "g",
    ...
    conversions: [
      { unitName: "cebolla mediana", gramsPerUnit: 120 },
      { unitName: "cebolla pequeña", gramsPerUnit: 70 },
    ],
  },
  {
    name: "Chalotas",
    ...
    conversions: [{ unitName: "chalota", gramsPerUnit: 20 }],
  },
  {
    ...
    conversions: [
      { unitName: "pimiento seco", gramsPerUnit: 25 },
      { unitName: "cucharada pulpa", gramsPerUnit: 15 },
    ],
  },
  {
    name: "Ñora",
    ...
    conversions: [
      { unitName: "ñora seca", gramsPerUnit: 15 },
      { unitName: "cucharada pulpa", gramsPerUnit: 15 },
    ],
  },
  {
    ...
    conversions: [
      { unitName: "cucharadita rallada", gramsPerUnit: 5 },
      { unitName: "trozo (3cm)", gramsPerUnit: 15 },
    ],
  },
  {
    name: "Apio nabo",
    ...
    conversions: [{ unitName: "unidad mediana", gramsPerUnit: 600 }],
  },
  {
    name: "Pak choi",
    unit: "g",
